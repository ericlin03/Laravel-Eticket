  ...
  <div class="row" style="margin-top:90px;">
    <div class="col-12">
      <ul class="nav nav-tabs nav-justified" style="margin-top:0px;">
        <li class="active col-3"><a class="nav-link active" data-toggle="tab" href="#home"><img
              src="images/buyticket.png" width="80" height="80" class="d-inline-block align-top" alt=""><br><span
              style="font-size:50px">購票</span></a></li>
        <li class="col-3"><a class="nav-link" data-toggle="tab" href="#menu1"><img src="images/check-in-with-card.png"
              width="80" height="80" class="d-inline-block align-top" alt=""><br><span
              style="font-size:50px">入場</span></a></li>
        <li class="col-3"><a class="nav-link" data-toggle="tab" href="#menu2"><img src="images/error.png" width="80"
              height="80" class="d-inline-block align-top" alt=""><br><span style="font-size:50px">退票</span></a></li>
        <li class="col-3"><a class="nav-link" data-toggle="tab" href="#menu3"><img src="images/question.png" width="80"
              height="80" class="d-inline-block align-top" alt=""><br><span style="font-size:50px">其他</span></a></li>
      </ul>
    </div>
  </div>
      ...
      <div class="container">
        <div class="row">
          <div class="container">
            ...
            <div id="accordion1">
              <div
                style="background-color:#f0f0f0; padding-top:10px; padding-bottom:35px; margin-bottom:5px; border-radius:0.25rem;">
            ...
            <div id="accordion9">
              <div
                ...
                <div id="collapse9" class="collapse" data-parent="#accordion9">
                  <br><br>表示該區已無 2 張連續座位，僅剩零散的單 1 座位，因此若要購買 2 張連續座位請選擇其它區域。如不介意座位是否連續，請嘗試選擇 1 張票券，加購兩次後即可能訂到該區兩張座位
                  (若剩餘座位數足夠)。
                </div>
              </div>
            </div>
            ...
            <div id="accordionFour2">
              <div
                ...
                <div id="collapseFour2" class="collapse" data-parent="#accordionFour2">
                  ...
                  <br><br>
                  Please enter your ID card number or passport number (foreigners only), and the column cannot be
                  changed once entered. If the passport number has fewer than 10 digits, please input extra zero(s) in
                  front of your passport number. If the passport number has over 10 digits, please input the first 10
                  digits only.
                  <br>
