...
<div class="container">
  @empty($act)
  <div><br><br><br>
    <h3 style="color:red">伺服器出問題啦～～～塊陶啊～～～</h3><br><br><br>
  </div>
  @endempty
</div>
    ...
    <div class="col-md-4 pb-1 pb-md-0">
      <div class="card h-100">
        <img class="card-img-top" src="{{$program->img }}" height="180" alt="Card image cap" data-toggle="modal"
          data-target="#{{ $program->prog_id }}">
        <div class="modal fade" id="{{ $program->prog_id }}" tabindex="-1" role="dialog"
          aria-labelledby="myLargeModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-lg" id="{{ $program->prog_id }}">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="myLargeModalLabel">{{"$program->prog_name"}}</h5>
